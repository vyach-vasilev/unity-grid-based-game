...
public class MagicAttackState : State<UnitController, UnitState>
{
    private static readonly int MagicAttack = Animator.StringToHash("Magic Attack");
    private readonly UnitStateMachine<UnitController, UnitState> _stateMachine;

    private InputManager _inputManager;
    
    public MagicAttackState(UnitState id, UnitStateMachine<UnitController, UnitState> stateMachine) : base(id)
    {
    ...
    public override void Execute(UnitController owner)
    {
        ...
        owner.Animator.SetTrigger(MagicAttack);
