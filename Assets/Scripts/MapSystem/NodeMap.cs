...
public class NodeMap
{
    ...
    public static void Create(Vector2 mapSize, Vector3 position, float nodeRadius, LayerMask unWalkableMask)
    {
        Instance = new NodeMap(mapSize, position, nodeRadius, unWalkableMask);
    }
    
    public NodeMap(Vector2 mapSize, Vector3 position, float nodeRadius, LayerMask unWalkableMask)
    {
